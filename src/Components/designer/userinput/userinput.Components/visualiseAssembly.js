...
export default function VisualiseAssembly(props) {
  ...
  React.useEffect(() => {
    ...
    (async () => {
      ...
      const response = await fetch('http://127.0.0.1:5000/s?build='+JSON.stringify(props.shoppingBagItems));
  ...
  return (
    <div>
      ...
      >
        <DialogTitle id="alert-dialog-slide-title">Assembly Sequence</DialogTitle>
        <DialogContent>
